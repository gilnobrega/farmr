...
### Farmer/Full-node
1. Download [farmr-fedora-x86_64.rpm](https://github.com/joaquimguimaraes/farmr/releases/download/v1.5.2.1/farmr-fedora-x86_64.rpm) from the [latest release](https://github.com/joaquimguimaraes/farmr/releases/latest), open it and install it.
