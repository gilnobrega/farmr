...
### Farmer/Full-node
1. Download [farmr-fedora-x86_64.deb](https://github.com/joaquimguimaraes/farmr/releases/download/v1.4.3/farmr-fedora-x86_64.deb) from the [latest release](https://github.com/joaquimguimaraes/farmr/releases/latest), open it and install it.
