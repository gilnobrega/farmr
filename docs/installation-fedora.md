...
### Farmer/Full-node and Harvester
1. Download [farmr-fedora-x86_64.rpm](https://github.com/joaquimguimaraes/farmr/releases/download/v1.7.0.1/farmr-fedora-x86_64.rpm) from the [latest release](https://github.com/joaquimguimaraes/farmr/releases/latest), open it and install it.
